 ...
 */
package com.cybersolutions.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import com.cybersolutions.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "cybersolutionswebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "cybersolutionswebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "cybersolutionswebservices.oauth2.tokenUrl";

	private static final String DESC = "cybersolutionswebservices.v2.description";
	private static final String TITLE = "cybersolutionswebservices.v2.title";
	private static final String VERSION = "cybersolutionswebservices.v2.version";
